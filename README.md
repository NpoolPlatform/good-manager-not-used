...
[![Test](https://github.com/NpoolPlatform/good-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/good-manager/actions/workflows/main.yml)
...
* make good-manager ```单独编译服务```
* make good-manager-image ```单独生成服务镜像```
* make deploy-to-k8s-cluster ```部署到k8s集群```

### 步骤
* 在github上将模板仓库https://github.com/NpoolPlatform/good-manager.git import为https://github.com/NpoolPlatform/my-service-name.git
* git clone https://github.com/NpoolPlatform/my-service-name.git
* cd my-service-name
* mv cmd/good-manager cmd/my-service
