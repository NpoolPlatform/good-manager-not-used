module github.com/NpoolPlatform/good-manager
...
require (
	...
	github.com/NpoolPlatform/message v0.0.0-20221010081621-ec51d1ce8c77
	github.com/NpoolPlatform/service-template v0.0.0-20220927114621-4ecfdc51fb66
