...
const (
	// Label holds the string label denoting the stockv1 type in the database.
	Label = "stock_v1"
	...
	FieldSold = "sold"
	// Table holds the table name of the stockv1 in the database.
	Table = "stocks_v1"
)

// Columns holds all SQL columns for stockv1 fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
