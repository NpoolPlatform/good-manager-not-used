...
func CreateRecommends(ctx context.Context, in []*npool.RecommendReq) ([]*npool.Recommend, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.CreateRecommends(ctx, &npool.CreateRecommendsRequest{
			Infos: in,
		})
		if err != nil {
			return nil, err
	...
	return infos.([]*npool.Recommend), nil
}
...
func GetRecommendOnly(ctx context.Context, conds *npool.Conds) (*npool.Recommend, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.GetRecommendOnly(ctx, &npool.GetRecommendOnlyRequest{
			Conds: conds,
		})
		if err != nil {
			return nil, err
...
func ExistRecommend(ctx context.Context, id string) (bool, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.ExistRecommend(ctx, &npool.ExistRecommendRequest{
			ID: id,
		})
		if err != nil {
			return nil, err
